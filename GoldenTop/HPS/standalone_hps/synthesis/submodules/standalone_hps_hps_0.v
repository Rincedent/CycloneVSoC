...
module standalone_hps_hps_0 #(
		...
		inout  wire [39:0] mem_dq,                   //                    .mem_dq
		inout  wire [4:0]  mem_dqs,                  //                    .mem_dqs
		inout  wire [4:0]  mem_dqs_n,                //                    .mem_dqs_n
		...
		output wire        hps_io_trace_inst_CLK,    //                    .hps_io_trace_inst_CLK
		output wire        hps_io_trace_inst_D0,     //                    .hps_io_trace_inst_D0
		output wire        hps_io_trace_inst_D1,     //                    .hps_io_trace_inst_D1
		output wire        hps_io_trace_inst_D2,     //                    .hps_io_trace_inst_D2
		output wire        hps_io_trace_inst_D3,     //                    .hps_io_trace_inst_D3
		output wire        hps_io_trace_inst_D4,     //                    .hps_io_trace_inst_D4
		output wire        hps_io_trace_inst_D5,     //                    .hps_io_trace_inst_D5
		output wire        hps_io_trace_inst_D6,     //                    .hps_io_trace_inst_D6
		output wire        hps_io_trace_inst_D7      //                    .hps_io_trace_inst_D7
	);
	...
	standalone_hps_hps_0_fpga_interfaces fpga_interfaces (
	...
	standalone_hps_hps_0_hps_io hps_io (
		...
		.hps_io_can0_inst_RX      (hps_io_can0_inst_RX),      //       .hps_io_can0_inst_RX
		.hps_io_can0_inst_TX      (hps_io_can0_inst_TX),      //       .hps_io_can0_inst_TX
		.hps_io_trace_inst_CLK    (hps_io_trace_inst_CLK),    //       .hps_io_trace_inst_CLK
		.hps_io_trace_inst_D0     (hps_io_trace_inst_D0),     //       .hps_io_trace_inst_D0
		.hps_io_trace_inst_D1     (hps_io_trace_inst_D1),     //       .hps_io_trace_inst_D1
		.hps_io_trace_inst_D2     (hps_io_trace_inst_D2),     //       .hps_io_trace_inst_D2
		.hps_io_trace_inst_D3     (hps_io_trace_inst_D3),     //       .hps_io_trace_inst_D3
		.hps_io_trace_inst_D4     (hps_io_trace_inst_D4),     //       .hps_io_trace_inst_D4
		.hps_io_trace_inst_D5     (hps_io_trace_inst_D5),     //       .hps_io_trace_inst_D5
		.hps_io_trace_inst_D6     (hps_io_trace_inst_D6),     //       .hps_io_trace_inst_D6
		.hps_io_trace_inst_D7     (hps_io_trace_inst_D7)      //       .hps_io_trace_inst_D7
	);
